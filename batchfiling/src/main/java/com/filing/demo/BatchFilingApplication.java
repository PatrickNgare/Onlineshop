package com.filing.demo;

import com.filing.demo.config.CustomerReportJobConfig;
...
@Slf4j
@EnableScheduling
public class BatchFilingApplication {

    public static void main(String[] args) {
        prepareTestData(100);
        SpringApplication.run(BatchFilingApplication.class, args);
    }
